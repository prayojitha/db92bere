...
router.get('/', function(req, res) {
  res.render('index', { title: 'Electronic app' , user : req.user });
});

router.get('/register', function(req, res) {
  res.render('register', { title: 'Electronic App registration' });
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Electronic App Login', user : req.user });
});
