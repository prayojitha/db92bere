...
router.get("/electroniccreate",secured, electronic_controlers.electronic_create_Page);

router.get("/electronicupdate",secured, electronic_controlers.electronic_update_Page);
router.get("/electronicdelete",secured, electronic_controlers.electronic_delete_Page);
